...
export default class Track {
  ...
  render(instance, parentElement, name) {
    ...
    const datumContainer = this.renderBlock(
      track,
      this.data,
      instance._layout,
      this.conf,
    ...
    const selection = this.renderDatum(
      datumContainer,
      this.conf,
      instance._layout,
    );
  ...
  x(d, layout, conf) {
    ...
    const angle =
      this.theta(d.position, layout.blocks[d.block_id]) - Math.PI / 2;
